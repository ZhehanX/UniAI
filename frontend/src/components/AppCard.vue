<template>
    <div
        class="group cursor-pointer bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col md:flex-row w-full mx-auto">
        <!-- Image Section (20%) -->
        <div class="w-full md:w-1/5 flex-shrink-0 bg-gray-100 border-r border-gray-200">
            <div v-if="!app.imagePath"
                class="w-full h-full flex items-center justify-center text-gray-400 p-4 min-h-[200px]">
                <svg class="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            </div>
            <img v-else :src="app.imagePath" :alt="app.name"
                class="w-full h-full object-cover min-h-[200px] md:min-h-[300px]">
        </div>

        <!-- Content Section (80%) -->
        <div class="w-full md:w-4/5 p-6 md:p-8 flex flex-col justify-between">
            <div>
